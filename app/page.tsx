export default function NothingnessEPK() {
  ...
  const merchImages = [
    { src: "/shirt1.jpeg", className: "crop" },
    { src: "/shirt2.jpeg", className: "crop" },
    { src: "/shirt3.jpeg", className: "contain" },
    { src: "/shirt4.jpeg", className: "contain" },
    { src: "/shirt5.jpeg", className: "crop" },
    { src: "/shirt6.jpeg", className: "crop" },
  ];
                  ...
                  <div style={styles.merchImageWrap}>
                    <img
                      ...
                      style={{
                        ...styles.merchImage,
                        ...(item.className === "crop"
                          ? styles.merchImageCrop
                          : styles.merchImageContain),
                      }}
                    />
                  </div>
                </div>
