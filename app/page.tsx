export default function NothingnessEPK() {
  ...
  const showHistory = [
    ...
    "8/12/2023 - INDIANAPOLIS (Black Circle): Heavy Hell IV (Mortician, Profanatica, Temple of Void, Deceased, etc.)",
    ...
    <div style={styles.page}>
      <style>{`
        * {
        ...
        .fade-delay-1 { animation-delay: 0.04s; }
        .fade-delay-2 { animation-delay: 0.08s; }
        .fade-delay-3 { animation-delay: 0.12s; }
        ...
        <div className="container">
          <div style={styles.panel} className="panelPad fade-in fade-delay-1">
            ...
            <div className="albumGrid">
              {albums.map((album) => (
                <div key={album.title} style={styles.albumCard}>
      ...
      <section style={styles.section}>
        <div className="container twoCol">
          ...
          <div style={styles.panel} className="panelPad fade-in fade-delay-2">
            <p style={styles.sectionLabel}>Appearances / Conversations</p>
            <div style={styles.sectionDivider} />
            <p style={styles.bodyCopy}>
        ...
        <div className="container">
          <div style={styles.panel} className="panelPad fade-in fade-delay-1">
            ...
            <div className="videoGrid">
              {signaturetonePerformances.map((item) => (
                <a
                  key={item.title}
                  href={item.href}
                  target="_blank"
                ...
                >
                  ...
                  <div style={styles.videoMeta}>{item.date}</div>
      ...
      <section style={styles.section}>
        <div className="container">
          <div style={styles.panel} className="panelPad fade-in fade-delay-1">
            ...
            <p style={styles.bodyCopy}>
              Selected flyers from notable appearances and a running performance
              history.
            </p>
            ...
            <div style={styles.showScrollContainer}>
              <div style={styles.showScrollHeader}>
                ...
                <div style={styles.showScrollHint}>Scroll to view full list</div>
              </div>
