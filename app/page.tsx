export default function NothingnessEPK() {
  ...
  const podcastLinks = [
    {
      ...
      href: "https://open.spotify.com/episode/2h1wskPx7LThJ3CHRxddph?si=lIoV9GOhTgaygmN-No8cOw",
    },
    {
  ...
  const merchImages = [
    { src: "/shirt1.jpeg", title: "Past Design 1" },
    { src: "/shirt2.jpeg", title: "Past Design 2" },
    { src: "/shirt3.jpeg", title: "Past Design 3" },
    { src: "/shirt4.jpeg", title: "Past Design 4" },
    { src: "/shirt5.jpeg", title: "Past Design 5" },
    { src: "/shirt6.jpeg", title: "Past Design 6" },
  ];
    ...
    <div style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.logoWrap}>
          <img src="/logo.jpeg" alt="Nothingness logo" style={styles.logo} />
        </div>
      ...
      <section style={styles.section}>
        <div style={styles.twoCol}>
          ...
          <div style={styles.panel}>
            ...
            <p style={styles.bodyCopy}>
              Interviews, podcast appearances, and extended conversations.
            </p>
      ...
      <section style={styles.section}>
        <div style={styles.panel}>
          ...
          <h2 style={styles.sectionTitle}>Flyers and show history</h2>
          <p style={styles.bodyCopy}>
        ...
        <div style={styles.panel}>
          <div style={styles.merchHeaderRow}>
            <div>
              ...
              <h2 style={styles.sectionTitle}>Past Designs</h2>
              <p style={styles.bodyCopy}>
                Selected past shirt designs, with current inventory available in
                the merch store.
              </p>
            </div>
            ...
            {merchImages.map((item) => (
              ...
              >
                <div style={styles.merchCard}>
                  <div style={styles.merchImageWrap}>
                    <img
                      src={item.src}
                      alt={item.title}
                  ...
                  <div style={styles.merchCaption}>{item.title}</div>
                </div>
              </a>
            ))}
          </div>
