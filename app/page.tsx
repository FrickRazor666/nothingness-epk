    ...
    <div style={styles.page}>
      <style>{`
        * {
        ...
        .statsScroller {
          display: grid;
          grid-template-columns: minmax(320px, 1.5fr) repeat(3, minmax(200px, 1fr));
          gap: 16px;
          margin-top: 32px;
          text-align: left;
        }
      ...
      <section style={styles.heroSection}>
        <div className="container hero">
          ...
          <p style={styles.headerText} className="heroText">
      ...
      <section style={styles.section}>
        <div className="container twoCol">
          <div style={styles.panel} className="panelPad">
