        ...
        <div style={styles.panel}>
          <div style={styles.merchHeaderRow}>
            <div>
              ...
              <h2 style={styles.sectionTitle}>Visual merch preview</h2>
              <p style={styles.bodyCopy}>
                Current merch presentation featuring front print and sleeve
                detail, with full store inventory available via Bandcamp.
              </p>
            </div>
          ...
          <div style={styles.merchGrid}>
            {merchImages.map((item) => (
              <div key={item.title} style={styles.merchCard}>
